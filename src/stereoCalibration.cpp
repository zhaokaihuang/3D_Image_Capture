...
//                cout << "After image resize, the image " << filename << " has the same size as the first image size. Skipping the pair\n";
                //cout<<img.size()<<endl;
                //break;
            }
            bool found = false;
...
static bool readStringList( const string& filename, vector<string>& l )
{
    ...
    if( !fs.isOpened() ){
        cout<<"file storage not opened"<<endl;
        return false;
    }
...
int main(int argc, char** argv)
{
    ...
    cout<<"Loading pairs of RGB and depth images..."<<endl;
    ...
    StereoCalib(imagelist, boardSize,true, true, false);
    return 0;
}
